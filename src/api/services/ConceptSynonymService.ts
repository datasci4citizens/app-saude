...
export class ConceptSynonymService {
   ...
   * @throws ApiError
   */
  public static apiConceptSynonymList(): CancelablePromise<
    Array<ConceptSynonymRetrieve>
  > {
   ...
   * @throws ApiError
   */
  public static apiConceptSynonymDestroy(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/concept-synonym/{id}/",
      path: {
