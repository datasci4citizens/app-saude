...

  {
    variants: {
      variant: {
        ...
        periodActive: "bg-homebg text-primary-foreground hover:bg-homebg/90 shadow-lg border-2 border-homebg transform hover:scale-[1.02]",
        periodInactive: "bg-card text-typography border-2 border-card-border hover:border-homebg/50 hover:bg-accent hover:text-homebg shadow-sm"
      },
      size: {
