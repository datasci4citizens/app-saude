...
const OnboardingSlider = () => {
  ...
  const handleNext = () => {
    if (currentStep < 2 && !animating) {
      setAnimating(true);
      // Let the animation complete before changing the step
      setTimeout(() => {
  ...
  return (
    <div className="onboarding-slider">
      ...
      <div className="slider-container" style={{transform: `translateY(-${currentStep * (100/3)}%)`}}>
