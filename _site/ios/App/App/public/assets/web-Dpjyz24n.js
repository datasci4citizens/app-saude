import { W as c } from './index-BTnpESFa.js';
class g extends c {
    constructor() {
        super();
    }
    loadScript() {
        ...
        const e = 'gapi';
        if (document == null ? void 0 : document.getElementById(e)) return;
        ...
        ((t.type = 'text/javascript'),
            ...
            (t.async = !0),
            (t.id = e),
            (t.onload = this.platformJsLoaded.bind(this)),
            (t.src = 'https://apis.google.com/js/platform.js'),
            n.appendChild(t));
    }
    initialize(e = { clientId: '', scopes: [], grantOfflineAccess: !1 }) {
        var s, n;
        if (typeof window > 'u') return;
        const t =
                (s = document.getElementsByName('google-signin-client_id')[0]) === null ||
                s === void 0
                    ? void 0
                    : s.content,
            i = e.clientId || t || '';
        return (
            i || console.warn('GoogleAuthPlugin - clientId is empty'),
            (this.options = {
                clientId: i,
    ...
    platformJsLoaded() {
        gapi.load('auth2', () => {
            ...
            (this.options.scopes.length && (e.scope = this.options.scopes.join(' ')),
                gapi.auth2.init(e),
                window.gapiResolve());
        });
    }
    async signIn() {
        return new Promise(async (e, s) => {
            ...
            try {
                ...
                i
                    ? (t = (await gapi.auth2.getAuthInstance().grantOfflineAccess()).code)
    ...
    async refresh() {
        ...
        return { accessToken: e.access_token, idToken: e.id_token, refreshToken: '' };
    }
    async signOut() {
    ...
    async addUserChangeListener() {
        (await this.gapiLoaded,
            gapi.auth2.getAuthInstance().currentUser.listen((e) => {
    ...
    getUserFrom(e) {
        const s = {},
            n = e.getBasicProfile();
        ((s.email = n.getEmail()),
            (s.familyName = n.getFamilyName()),
            (s.givenName = n.getGivenName()),
            (s.id = n.getId()),
            (s.imageUrl = n.getImageUrl()),
            (s.name = n.getName()));
